...
Four things are unread on the T14, and a measurement is owed for each.
...
`watchdog:` line off the log partition answers the first and third, and a
starved boot that comes back to Linux answers the second and fourth together.
