...
**`pid=Some(Pid(2)) tid=Some(Tid(0))` is `/system/bin/logd`'s main thread.** Measured,
...
```
[kernel 0.233 cpu0] spawn: /system/bin/init pid=0 tid=0 …
[kernel 0.235 cpu0] kthread: klogd pid=1 tid=0 runs in the kernel address space; a panic in it halts the machine
[kernel 0.260 cpu0] spawn: /system/bin/logd pid=2 tid=0 …
[kernel 0.291 cpu0] spawn: /system/bin/soundd pid=3 tid=0 …
[kernel 0.297 cpu0] spawn: /system/bin/test-runner pid=4 tid=0 …
[kernel 0.312 cpu0] spawn: /system/bin/test_rs_console_line_atomicity pid=5 …
```
