...
/// reads as a replug and cancels the enumeration it belongs to.
///
/// Here rather than at either caller, because both the machine and the
/// simulator that certifies it perform this write, and a simulator whose
/// acknowledge is a second copy of the driver's certifies a driver nobody
/// ships.
