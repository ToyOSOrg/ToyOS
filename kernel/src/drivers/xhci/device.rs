...
///
/// `after` is the reset this enumeration follows: a warm completion carries
/// the retrain's own connect edge (§4.19.5.1), consumed here or it reads as a
/// replug and cancels the enumeration it belongs to.
