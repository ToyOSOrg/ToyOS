...
pub fn arm(index: usize, regs: Mmio, found: Records, vector: u8) {
    ...
    // Generated by the remapping hardware itself, so interrupt remapping never
    // blocks it: a compatibility message at the doorbell, destination 0.
    regs.write_u32(FEADDR_REG, crate::arch::MSI_DOORBELL);
