...
//! asked goes with the netd that carried it, and `logd` opens the stream again
//! once the new netd holds an address — so the verdict is whatever init said,
//! as the machine's own log carries it.
